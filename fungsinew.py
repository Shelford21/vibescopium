...
if st.session_state["current_page"] == "DataFrames": 
    ...
    if "clean_df" not in st.session_state:
        st.error("Clean dataset is missing. Please load and clean data first.")
                ...
                # Load and preprocess data using cache
...
if st.session_state["current_page"] == "👨‍✈️ About Me": 
    st.markdown(
        ...
        <div class="transparent-container">
            <h1>👨‍✈️ About Me</h1>
            <h4>Hi, I’m Fauzan Fadhillah Arisandi! 

_

Right now, I’m working on my final project to complete my degree. I’m pursuing a bachelor’s degree, but for this last assignment, I need to create something useful for the community. That’s why I’m building VibeScopium 🚀—a sentiment analysis app that determines whether a review is positive or negative. The cool part? It focuses only on reviews from Indonesia 🇮🇩.

VibeScopium is powered by TF-IDF and Logistic Regression 🤖📊. Basically, it converts text into numerical values using TF-IDF (Term Frequency-Inverse Document Frequency) to figure out which words are important, and then Logistic Regression steps in to classify whether a review is positive or negative. This makes the analysis fast, efficient, and accurate! If an app is flooded with bad reviews, developers can quickly identify issues and improve their products. On the flip side, positive sentiment means an app is doing great! 🎉

I’ve always been passionate about data science, and Python is my favorite language 🐍. VibeScopium is still a work in progress, and I’m constantly fine-tuning the model to make it even better. Working on this project has been a game-changer for me—I’ve learned so much about machine learning, NLP, and model optimization. It’s challenging, but honestly, I love every second of it. 🔥

Moving forward, I want to dive even deeper into data science and build more impactful projects. For now, my main focus is making VibeScopium as accurate and user-friendly as possible. Hopefully, it’ll become a valuable tool for developers, businesses, and anyone looking to understand Play Store reviews in Indonesia! 🚀
